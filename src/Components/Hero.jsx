...
import profilePic from "../assets/index1.png"
...
const Hero = () => {
  return (
    <div className="m-20 border-b border-neutral-900 pb-4 lg:mb-35">
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start">
                    ...
                    lg:text-6xl">Hy, I'm Dhruv Jangra
                    </motion.h1>
                    <motion.span
            ...
            <div className=" w-full  lg:w-1/5 p-1 ">
                <div className="flex justify-center">
                    ...
                    className=" rounded-2xl" src={profilePic} alt="Dhruv jangra" />
                </div>
            </div>
        </div>
    </div>
